...
export async function generateMetadata({ params }) {
  ...
  const pageUrl = `https://www.freelancefeecalc.site/${countrySlug}/${platformSlug}`;

  // No "| FreelanceFeeCalc" here — layout.js template adds it automatically
  const title = `${platformName} Fee Calculator ${countryName} (${currencySymbol})`;
  ...
  return {
    ...
    twitter: {
      ...
      title,
      description,
      images: [`https://www.freelancefeecalc.site/${countrySlug}/${platformSlug}/opengraph-image`],
    },
    alternates: {
      canonical: pageUrl,
    },
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                ...
                {platform.paymentProcessingFixed > 0
                  ? ` plus a fixed fee of ${country.currencySymbol}${platform.paymentProcessingFixed}`
                  : ''}{' '}
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                Understanding the fee structure is the first step toward maximizing your profitability.
                Some platforms offer tiered pricing or membership plans that can reduce your effective
                commission rate. If {platform.name} offers such options, it may be worth calculating
                whether the upfront cost of a premium plan is offset by the savings on platform fees.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                ...
                {platform.paymentProcessingFixed > 0
                  ? ` plus a fixed transaction fee of ${country.currencySymbol}${platform.paymentProcessingFixed}`
              ...
              itemListElement: [
                {
                  ...
                  position: 1,
                  name: 'Home',
                  item: 'https://www.freelancefeecalc.site',
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: country.name,
                  item: `https://www.freelancefeecalc.site/${countrySlug}`,
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: `${platform.name} Calculator`,
                  item: `https://www.freelancefeecalc.site/${countrySlug}/${platformSlug}`,
                },
              ],
            }),
          }}
